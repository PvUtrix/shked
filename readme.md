...
Шкед — это комплексная система управления учебным процессом, разработанная специально для МФТИ. Платформа предоставляет инструменты для управления расписанием, домашними заданиями, посещаемостью, экзаменами и коммуникацией между всеми участниками образовательного процесса.
...
- 📋 **Лог активности** - полный аудит всех действий пользователей
...
| 👨‍🏫 **Lector** | Преподаватель | Управление предметами, ДЗ, экзаменами |
| 👔 **Assistant** | Ассистент | Помощь преподавателю, проверка работ |
| 🎤 **Co-Lector** | Со-преподаватель | Совместное ведение предмета |
...
> **Примечание**: В системе используется роль `lector` для преподавателей. Маршруты `/lector/*` доступны для преподавателей.
...
│   ├── lector/            # Страницы преподавателя (Lector role)
...
- [Отчёты о реализации](./docs/implementation/README.md)
- [Руководство пользователя](./docs/tutorials/README.md)
- [Шаблон ПТИ](./docs/testing/Acceptance_Testing_Template.md)
- [Требования](./docs/requirements/Roles_and_Functions_KTP_Variant_0.md)

### Техническая документация
- [API Reference](./docs/API.md)
- [Роли пользователей](./docs/features/USER_ROLES.md)
- [Telegram бот](./docs/features/TELEGRAM_BOT.md)
- [Лог активности](./docs/features/ACTIVITY_LOG.md)
...
**Статус проекта**: 🟢 Beta (v0.4.0-alpha) - 95% готовности  
