...
ШКЕД - современная веб-платформа для управления расписанием занятий в университете МФТИ, построенная на Next.js 14 с использованием App Router, Prisma ORM и PostgreSQL.
...
```bash
# Database
DATABASE_URL=postgresql://user:password@localhost:5432/shked
