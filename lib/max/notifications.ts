...
Пожалуйста, обратите внимание на изменения!`
    ...
    console.log(`Отправлено уведомлений об изменении: ${successCount}/${maxUsers.length}`)
...
Удачи в выполнении! 🎓`
    ...
    console.log(`Отправлено уведомлений о новом ДЗ: ${successCount}/${maxUsers.length}`)
    return successCount > 0
  } catch (error) {
