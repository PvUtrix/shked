  ...
  try {
    ...
    const thesis = await prisma.thesis.update({
      ...
      data: {
        ...
        milestones: validatedData.milestones !== undefined ? validatedData.milestones : (existingThesis.milestones as any),
        artifacts: validatedData.artifacts !== undefined ? validatedData.artifacts : (existingThesis.artifacts as any),
