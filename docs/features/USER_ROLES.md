...
### Руководитель образовательного офиса:
- **Главная**: `/education-office` - дашборд руководителя
- **Расписание**: `/education-office/schedule` - общее расписание
- **Отчеты**: `/education-office/reports` - отчеты по успеваемости и посещаемости
- **Кафедры**: `/education-office/departments` - управление кафедрами
- **Программы**: `/education-office/programs` - образовательные программы

### Администрация кафедры:
- **Главная**: `/department` - дашборд кафедры
- **Предметы**: `/department/subjects` - управление предметами кафедры
- **Преподаватели**: `/department/faculty` - управление преподавательским составом
- **Отчеты**: `/department/reports` - отчеты кафедры
- **Настройки**: `/department/settings` - настройки кафедры
