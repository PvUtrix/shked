...
### Настройка Bot Username для Deep Linking:

**Важно:** Для работы deep linking необходимо указать username бота в настройках через админ-панель:

1. Войдите в админ-панель
2. Перейдите в "Настройки" → "Telegram Bot"
3. Заполните поле "Bot Username" (без символа @)
4. Например, если ваш бот доступен как `@shked_bot`, укажите `shked_bot`
5. Сохраните настройки

После этого при получении ссылки для привязки будет автоматически генерироваться deep link.
